...
foods.push("pizza") && foods.push("cheesburger")
...
for (i = 0; i < numArrays.length; i++){
  ...
  total = total + numArrays[i][j] // Random question here, setting 'total = total + numArrays' gets this to work, but why doesn't it work if you just set 
                                  // 'total = numArrays' directly?
  }
}
